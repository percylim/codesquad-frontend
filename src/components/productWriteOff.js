  ...
  const data= {
       ...
       // alert(res.data);
         ...
         if (res.data === 'success') {
           ...
           window.location.href='productWriteOff';
...
const logstyle = {
  ...
  return (
    <div className="App">
    <div className="row">
    <div className="col-sm-12 btn btn-primary" style={{ 'height':"30px"}}>
        Product Write Off Entry
     </div>
    </div>
...
/>
      ...
      <a style={{ marginRight: '.6rem', marginLeft: '2.3rem' }}> Write Off Quantity : </a>
     ...
     />
                ...
                <button type="button" style={{backgroundColor: 'green', color: 'white', marginLeft: '2rem'}} onClick={onSave}
