...
var nMonth = '';
var cMonth = '';
function SalesPeriodicalReport() {
  ...
  const onPrint = async () => {
     if(data.length === 0) {
      alert('No Sales Analysis Report for printing');
      return false;
     }
  /*
        ...
        <div>
          ...
          <div className="row">
            ...
            <div className="col-sm-12" style={{ marginTop: '1px', backgroundColor: '#93fac0', color: 'black' }}>
              <h2>Periodical Sales Analysis Report</h2>
            </div>
          </div>
...
<button
            ...
            type='button'
            class='btn btn-danger float-right fa fa-close'
            onClick={() => onClear()}
...
<button
            style={{ padding: '1px', marginLeft: '2rem' }}
            type='button'
            class='btn btn-success fa fa-home'
            onClick={() => onHome()}
...
export default SalesPeriodicalReport;
