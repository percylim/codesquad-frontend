...
function PurchaseInvoicePayment() {
...
lDisable = false;
    setData(...data);
    window.location.href = '/purchaseInvoicePayment';
  };
 ...
 //   alert(suppGlNo+ " - "+suppGlSub);
    ...
    if (lOk === false) {
      alert("Voucher G/L No. and G/L Sub No. must match Supplier G/L No and G/L Sub No.");
      return false
  }
...
//return false
  ...
  const onSearchInvoice = async () => {
    ...
    if (invoiceNo === '' || invoiceNo === null) {
      alert("Purchase Invoice No. is blank");
      return false;
    }
    ...
    Axios
      .get(url + `/purchaseInvoiceSummary`,
        {
          params: {
            companyID: companyID,
            supplierID: supplierID,
    ...
    <div>
      ...
      <div>
        ...
        <label style={{ paddingLeft: "10px" }} >
          <a style={{ marginRight: '.5rem' }}> Supplier ID : </a>
          <input
            type="text"
            ...
            required
            disabled={lDisable}           data-tip data-for="supplierTip"
          />
          ...
          <a style={{ marginLeft: '.6rem', marginRight: '0.1rem' }} >Supplier Name : </a>
      ...
      <label style={{ paddingLeft: "10px" }} >
        ...
        <a style={{ marginLeft: '.5rem', marginRight: '.5rem' }} >Payment Date : </a>
        <input
          type="date"
          maxLength={10}
          value={txnDate}
      ...
      <div className="select-container" >
        ...
        <table class="table" style={{ paddingTop: '1px', border: '1px solid black' }}>
          ...
          <tbody style={mystyle} >
            ...
            <td style={{ textAlign: "center", backgroundColor: "cyan" }}>Payment Total :</td>
        ...
        <label style={{ paddingLeft: "10px" }} >
          ...
          <a style={{ marginLeft: '1rem', marginRight: '.6rem' }}> Pay Amount : </a>
...
<a style={{ marginRight: '.2rem' }}> Payment Particular : </a>
<input
  type="text"
...
/>
        ...
        <p></p>
        <td></td>
        <td><button style={{ backgroundColor: "blue", color: "white", width: '200px' }} onClick={() => onNew()}>New Payment </button></td>
        <td><button style={{ backgroundColor: "grey", color: "black", width: '100px' }} onClick={() => handleHome()}>Home</button></td>
        <td><button style={{ backgroundColor: "green", color: "white", width: '200px' }} onClick={() => onPrintPayment(data)}>Print Payment Detail</button></td>
        <td><button style={buttonStyle} type="button" onClick={onAddPayment}>Update Payment</button> </td>
        ...
        <div className="row">
          <div className="col-sx-12 btn btn-info" style={{ marginTop: '1px' }}>
            Purchase Invoice Payment Voucher Entry
          </div>
        </div>
        ...
        <div>
          ...
          <label style={{ paddingLeft: '10px' }}>
            ...
            <td><button style={{ backgroundColor: "red", color: "white", width: '300px' }} onClick={() => onSave(voucherData, totalDrAmt, totalCrAmt)}>Save Payment and Voucher</button></td>
